...
const aboutCopy = {
  primary: {
    ...
    title: "?.?.?",
    body: "Ο Μ.Τ.Ν είναι ένας καλλιτέχνης που κατά βάση ασχολείται με την hiphop μουσική. Από το 2021 εκπροσωπεί την συγκεκριμένη μουσικής ως : ράπερ και μουσικός παραγωγός. Η αγάπη του για την συγκεκριμένη μουσική αλλά και κουλτούρα ξεκίνησε το 2016 όπου ασχολήθηκε με το breakdance."
  },
  secondary: {
    kicker: "Signal notes",
    title: "?a?a????? / BHS",
    body: "Έπειτα ασχολήθηκε με τα scratch και από το 2021 μέχρι και σήμερα με την μουσική παραγωγή. Στις 20 Δεκεμβρίου του 2025 κυκλοφόρησε το πρώτο του δίσκο σαν μουσικός παραγωγός όπου συμμετέχουν 16 διαφορετικοί καλλιτέχνες συμπεριλαμβανομένου και του ίδιου. Από το καλοκαίρι του 2025 μέχρι και σήμερα είναι επίσημο μέλος των BHS από το Ηράκλειο της Κρήτης."
  }
};
